...
async function main() {
  ...
  const toys = [
    ...
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1507582020474-9a35b7d455d9?w=600&q=80"],
    ...
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1568393691622-c7ba131d63b4?w=600&q=80"],
    ...
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1563396983906-b3795482a59a?w=600&q=80"],
